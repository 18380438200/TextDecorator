...
public class ColorPickerView extends View {
  ...
  private final static int DEFAULT_SLIDER_COLOR = 0xFF000000;
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    huePanelWidthPx = CommonUtil.dip2px(getContext(), HUE_PANEL_WDITH_DP);
    alphaPanelHeightPx = CommonUtil.dip2px(getContext(), ALPHA_PANEL_HEIGH_DP);
    panelSpacingPx = CommonUtil.dip2px(getContext(), PANEL_SPACING_DP);
    circleTrackerRadiusPx = CommonUtil.dip2px(getContext(), CIRCLE_TRACKER_RADIUS_DP);
    sliderTrackerSizePx = CommonUtil.dip2px(getContext(), SLIDER_TRACKER_SIZE_DP);
    sliderTrackerOffsetPx = CommonUtil.dip2px(getContext(), SLIDER_TRACKER_OFFSET_DP);
  ...
  private void initPaintTools() {
    ...
    satValTrackerPaint.setStrokeWidth(CommonUtil.dip2px(getContext(), 2));
    ...
    hueAlphaTrackerPaint.setStrokeWidth(CommonUtil.dip2px(getContext(), 2));
    hueAlphaTrackerPaint.setAntiAlias(true);

    alphaTextPaint.setColor(0xff1c1c1c);
    alphaTextPaint.setTextSize(CommonUtil.dip2px(getContext(), 14));
  ...
  private void drawSatValPanel(Canvas canvas) {
    ...
    canvas.drawCircle(p.x, p.y, circleTrackerRadiusPx - CommonUtil.dip2px(getContext(), 1), satValTrackerPaint);
  ...
  private int getPreferredHeight() {
    int height = CommonUtil.dip2px(getContext(), 200);
